...
namespace vdivsvirus.interfaces
{
  ...
  /// </summary>
  public partial class SymptomeType : TBase
  {
    private string _id;
    private SymptomeClassifier _classifier;
    ...
    /// <summary>
    /// 
    /// <seealso cref="SymptomeClassifier"/>
    /// </summary>
    public SymptomeClassifier Classifier
    {
      get
      {
        return _classifier;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                Classifier = (SymptomeClassifier)await iprot.ReadI32Async(cancellationToken);
              }
              else
              {
                await TProtocolUtil.SkipAsync(iprot, field.Type, cancellationToken);
    ...
    public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var struc = new TStruct("SymptomeType");
        ...
        if (__isset.classifier)
        {
          field.Name = "classifier";
          field.Type = TType.I32;
          field.ID = 2;
          await oprot.WriteFieldBeginAsync(field, cancellationToken);
          await oprot.WriteI32Async((int)Classifier, cancellationToken);
          await oprot.WriteFieldEndAsync(cancellationToken);
        }
    ...
    {
      var other = that as SymptomeType;
      if (other == null) return false;
      if (ReferenceEquals(this, other)) return true;
      return ((__isset.id == other.__isset.id) && ((!__isset.id) || (System.Object.Equals(Id, other.Id))))
        && ((__isset.classifier == other.__isset.classifier) && ((!__isset.classifier) || (System.Object.Equals(Classifier, other.Classifier))))
    ...
    public override int GetHashCode() {
      ...
      unchecked {
        ...
        if(__isset.classifier)
          hashcode = (hashcode * 397) + Classifier.GetHashCode();
        if(__isset.name)
    ...
    {
      var sb = new StringBuilder("SymptomeType(");
      bool __first = true;
      if (Id != null && __isset.id)
      {
