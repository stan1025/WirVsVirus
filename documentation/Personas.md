...
![Persona Robert](images/PersonaRobert.PNG){:height="50px"}
...
![Persona Gabi](images/PersonaGabi.PNG){:height="70px"}
...
![Persona Ernst](images/PersonaErnst.PNG){:height="30px"}
...
![Persona Anna](images/PersonaAnna.PNG){:height="40px"}
